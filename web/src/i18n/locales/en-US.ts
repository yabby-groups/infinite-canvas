export default {
    ...
    agent: {
        ...
        siteTools: { canvasList: "Canvas list", generationStatus: "Generation task status", imageConfig: "Image configuration", imageGenerate: "Generate in Image Studio", videoConfig: "Video configuration", videoGenerate: "Generate in Video Studio", videoMerge: "Merge canvas videos", mediaInspect: "Inspect canvas media", mediaRender: "Render media", mediaTts: "Generate voiceover", mediaTranscribe: "Transcribe media", promptSearch: "Search prompts", assetList: "Asset list", assetAdd: "Add asset", unknownTool: "Unknown tool: {{name}}", canvasLoading: "The canvas is still loading. Try again shortly.", canvasHint: "Use site_navigate to open /canvas/{id}", videoMergeCanvasRequired: "Open a canvas containing video nodes first.", videoMergeCount: "Select at least two video nodes.", videoMergeUnavailable: "A selected video is not available in the local media library.", videoMergeFailed: "Video merge failed.", mediaCanvasRequired: "Open a canvas with local media first.", mediaUnavailable: "A selected item is unavailable in the local media library.", mediaVideoRequired: "Select a video node.", mediaAudioRequired: "Select an audio or video node.", mediaTextRequired: "Provide text for the voiceover.", assetsLoading: "Assets are still loading. Try again shortly.", assetTitleRequired: "Provide the asset title", textContentRequired: "content is required when kind=text", imageUrlRequired: "imageUrl is required when kind=image", imageReadFailed: "Could not read the image. Use a data URL or a cross-origin accessible image URL.", assetKindUnsupported: "assets_add supports only kind=text or kind=image", imageGenerationStarted: "Opened Image Studio and started generation. Use generation_get_status to query the task.", imageConfigApplied: "Opened Image Studio and applied the parameters without starting generation.", videoGenerationStarted: "Opened Video Studio and started generation. Use generation_get_status to query the task.", videoConfigApplied: "Opened Video Studio and applied the parameters without starting generation." },
